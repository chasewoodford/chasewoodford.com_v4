...
$typology_translate = array(
	'latest_stories' => array( 'text' => esc_html__( 'Latest Posts', 'typology' ), 'desc' => 'Home page posts section title' ),
	...
	'read_on' => array( 'text' => esc_html__( 'Read More', 'typology' ), 'desc' => 'Read more button label' ),
